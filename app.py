...
with st.sidebar:
    ...
    """, unsafe_allow_html=True)
    st.markdown(f"<p style='color:{TEXT_SECONDARY};font-size:11px;text-transform:uppercase;letter-spacing:1px;margin-top:8px;'>Navigation</p>", unsafe_allow_html=True)
    st.page_link("app.py", label="🏠 Home")
    st.page_link("pages/2_unit_economy.py", label="🧮 Unit Economy")
